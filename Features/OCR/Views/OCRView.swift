    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                // if GlobalBackgroundProcessingManager.shared.isBackgroundProcessing && GlobalBackgroundProcessingManager.shared.isIndicatorVisible {
                //     globalBackgroundProcessingIndicator(dismissAction: {
                //         GlobalBackgroundProcessingManager.shared.dismissIndicator()
                //     })
